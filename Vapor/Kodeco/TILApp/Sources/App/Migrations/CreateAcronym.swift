...
// Define a new type, CreateAcronym that conforms to Migration.
struct CreateAcronym: Migration {
    ...
    func prepare(on database: Database) -> EventLoopFuture<Void> {
        ...
        database.schema("acronyms")
            ...
            .id()
            // Define columns for short and long. Set the column type to string and mark the columns as required. This matches the non-optional String properties in the model. The field names must match the key of the property wrapper, not the name of the property itself.
